...
-- vim.api.nvim_set_keymap('n', '<leader>p', '<cmd>NERDTree<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>p', '<cmd>NERDTreeToggle<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>x', '<cmd>NERDTreeClose<CR>', { noremap = true, silent = true })
